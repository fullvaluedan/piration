...
const CAPTAIN_DEFS = [
  ...
  {
    id: "resourcetrader",
    name: "The Resource Trader",
    title: "Barter of the Isles",
    element: "Earth",
    starter: false,
    unlock: { level: 12, resourcesCollected: 200 },
    focus: "Profit from every storm",
    ability: {
      name: "Fair Barter",
      desc: "+25% Marks from every victory.",
      kind: "marksBonus",
      value: 0.25,
    },
    icon: "💰",
    poolSize: 46,
    kindMix: { Attack: 0.32, Defend: 0.28, Skill: 0.3, Resource: 0.1 },
  },
  {
    id: "rustbeard",
    name: "Rustbeard",
  ...
  {
    id: "commodore",
    name: "Commodore Chompington",
    title: "The Coral Officer",
    element: "Water",
    starter: false,
    unlock: { level: 13, eliteKills: 6, MapFragment: 4 },
    focus: "Discipline and defense",
    ability: {
      name: "Cold Cannonade",
      desc: "Gain 2 shield at the start of each of your turns.",
      kind: "shieldPerTurn",
      value: 2,
    },
    icon: "🛡",
    poolSize: 46,
    kindMix: { Attack: 0.34, Defend: 0.3, Skill: 0.26, Resource: 0.1 },
  },
  {
    id: "admiralironsides",
    name: "Admiral Ironsides",
    title: "The Old Guard",
    element: "Ice",
    starter: false,
    unlock: { level: 18, endlessWave: 35, eliteKills: 12 },
    focus: "Steady as the tide",
    ability: {
      name: "Iron Discipline",
      desc: "Heal 2 at the start of each of your turns.",
      kind: "healPerTurn",
      value: 2,
    },
    icon: "🎖",
    poolSize: 46,
    kindMix: { Attack: 0.34, Defend: 0.2, Skill: 0.36, Resource: 0.1 },
  },
];
...
const GAME = {
  ...
  balance: {
    ...
    energy: { unlimited: true, max: 100, regenSec: 300, gatherCost: 3, combatCost: 8 },
    elementMult: 1.5,
    elementWeak: 0.75,
    bribeCostMult: 0.6,
  ...
  elements: {
    Fire: { strong: ["Ice", "Earth"], weak: ["Water", "Light"] },
    Water: { strong: ["Fire", "Earth"], weak: ["Lightning", "Ice"] },
    Earth: { strong: ["Lightning", "Air"], weak: ["Ice", "Fire"] },
    Air: { strong: ["Ice", "Light"], weak: ["Earth", "Lightning"] },
    Lightning: { strong: ["Water", "Air"], weak: ["Earth", "Dark"] },
    Ice: { strong: ["Earth", "Water"], weak: ["Fire", "Air"] },
    Light: { strong: ["Dark", "Fire"], weak: ["Air", "Water"] },
    Dark: { strong: ["Light", "Lightning"], weak: ["Fire", "Light"] },
  },
  zones: [
    {
      id: "shallows",
    ...
    },
    {
      id: "skullbone",
      name: "Skullbone Cove",
      desc: "Bone-white cliffs and old wars. No bosses, just teeth.",
      minLevel: 8,
      enemyHp: 66,
      enemyDmg: 11,
      voyageLength: 3,
      encounterWeights: { monster: 0.66, elite: 0.18, cache: 0.16 },
      monsterPool: ["reef_horror", "iron_privateer", "kraken_spawn"],
      elitePool: ["kraken_spawn", "siren_barge"],
      boss: null,
      lootWeights: { Wood: 16, Cotton: 14, Iron: 22, GoldNugget: 11, Rum: 7, CannonPart: 7, MapFragment: 5, Marks: 17, Gold: 7 },
      lootMin: 3,
      lootMax: 5,
      marks: [30, 58],
      gold: [1, 7],
    ...
    },
    {
      id: "gilded",
      name: "Gilded Straits",
      desc: "Fortune's own waterway. Rich wrecks, sharper fangs.",
      minLevel: 16,
      enemyHp: 124,
      enemyDmg: 21,
      voyageLength: 3,
      encounterWeights: { monster: 0.58, elite: 0.26, cache: 0.16 },
      monsterPool: ["abyssal_tender", "siren_barge", "triangle_sphinx"],
      elitePool: ["abyssal_tyrant", "abyssal_tender"],
      boss: null,
      lootWeights: { Wood: 10, Cotton: 10, Iron: 18, GoldNugget: 17, Rum: 11, CannonPart: 12, MapFragment: 13, Marks: 19, Gold: 12 },
      lootMin: 4,
      lootMax: 8,
      marks: [66, 128],
      gold: [5, 18],
  ...
  ships: [
    ...
    { id: "sloop", name: "Sloop", level: 4, hull: 50, cannons: 2, slots: 3, cost: { Wood: 15, Cotton: 8, Iron: 5, Marks: 150 } },
    { id: "frigate", name: "Frigate", level: 10, hull: 78, cannons: 3, slots: 4, cost: { Wood: 32, Cotton: 18, Iron: 14, GoldNugget: 3, Marks: 500 } },
    { id: "galleon", name: "Galleon", level: 16, hull: 110, cannons: 4, slots: 5, cost: { Wood: 55, Cotton: 30, Iron: 26, GoldNugget: 6, CannonPart: 5, Marks: 1000 } },
  ],
  recipes: [
